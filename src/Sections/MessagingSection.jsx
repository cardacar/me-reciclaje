...
import messaging from '../assets/img/cortina-de-botellas.jpg'
         ...
         <InnerLayout>
            <div className='message-con'>
               <div className="left-items">
                  ...
                  Nuestra razon fundamental es brindar comodidad confort, protección y decoración para el cubrimiento de sus ventanas, proporcionando a las personas y organzaciones en un entorno amable, con parametro de calidad honestidad y cumplimiento
                  </p>
